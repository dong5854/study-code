...
- i want to find a [cheap](price) re`staurant
...
## intent: reserve_time
- I'd like to make a reservation for [breakfast](time).
- I want to have [breakfast](time).
- [breakfast](time)
- I'm going to have [breakfast](time).
- I'd like to make a reservation for [lunch](time).
- I want to have [lunch](time).
- [lunch](time)
- I'm going to have [lunch](time).
- I'd like to make a reservation for [dinner](time).
- I want to have [dinner](time).
- [dinner](time)
- I'm going to have [dinner](time).
- Make a reservation for [breakfast](time), please.
- Make a reservation for [lunch](time), please.
- Make a reservation for [dinner](time), please.
- I'll have [breakfast](time).
- I'll have [lunch](time).
- I'll have [dinner](time).